...
export function SelectInput({ label, options }: SelectInputProps) {
  return (
    <div className="relative w-full -mt-px first:mt-0">
      ...
      <select className="w-full transition-all focus:outline-none focus:border-black focus:relative focus:z-10 cursor-pointer appearance-none border border-front-door-navy pt-6 pb-2 px-4 text-base bg-transparent bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2212%22%20height%3D%228%22%20viewBox%3D%220%200%2012%208%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M1%201L6%206L11%201%22%20stroke%3D%22%23000%22%20stroke-width%3D%221.5%22%2F%3E%3C%2Fsvg%3E')] bg-no-repeat bg-[right_16px_center]">
